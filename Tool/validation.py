...
def update_material_checkbox(self, context):
    # materials cannot be "selected" in the viewport like meshes, but we store the flag for use by fix operators
...
class SceneChecker(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        scene = context.scene # simplify script for future use
        ...
        # MATERIALS
        # we check both in the mesh material data and also the overall materials in our scene
